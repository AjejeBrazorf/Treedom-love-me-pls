...
export default function App() {
  let [showChameleon, setChameleon] = useState(false);
  ...
  function toggleChameleon() {
    setChameleon(!showChameleon);
  }


  return (
      <div className="App">
        <Navbar onTopNavClick={toggleChameleon}/>
        <Chameleon animate={showChameleon} toggleAnim={toggleChameleon} />
        <div className="layout">
          <section id="top" className="background" style={{backgroundImage: `url(${data.coverImage})`}}/>
          <section id="introduction">
            <div className="content introduction">
              <h3>Dear Treedom,</h3>
              <span>{data.motivational}</span>
            </div>
          </section>
          <section className="alternate-bg" id="profile">
            <div className="content profile">
              <div>
                <Carousel className="white-card slideshow" images={data.slides} />
                <div className="white-card expertise">
              ...
              <div>
                <div className="white-card">
                  <div className="white-card--header">
                    <div className="white-card--group-title">
                      <img src={data.profilePic} />
                      <span className="details">
                        <h5>{data.name}</h5>
                        <span><b>Origin:</b> {data.background.Origin}</span>
                        <span><b>Age:</b> {data.background.age}</span>
                        <span><b>Education:</b> {data.background.education.title}</span>
                        <span><b>Email:</b> <a href={`mailto:${data.email}`}>{data.email}</a></span>
                      </span>
                    </div>
                  </div>
                  <div className="checkout">
                    <div className="prices">
                      ...
                      <span className="real-price">&#8364; 0.00</span>
                    </div>
                    <a href={`mailto:${data.email}`} className="button">Contact</a>
                  </div>
                  <b>What's the story behind this guy?</b>
                  <br/><br/>
                  <span className="story">
                    {data.story}<br /><br />
                    Now the real question is:<br />
                    <b>is there a chance to continue this story with Treedom?</b>
                  </span>
                </div>
              </div>
            </div>
          ...
          <section id="mention">
            <div className="content">
              <h3>Fun fact</h3>
              <span> I found this nice comment on your website's console! </span>
              <div className="card">
            ...
            <div className="content">
              ...
              <div className="contacts">
                <a href={data.cv} className="row">
                  ...
                  <span>Take a look to my resume</span>
                </a>
                <div className="row">
                  <svg
                      className="mail"
                  ...
                  <a href={`mailto:${data.email}`}>Let's get in touch</a>
                </div>
              </div>
            </div>
          </section>
